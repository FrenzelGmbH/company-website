...
class Categories extends \yii\db\ActiveRecord
{
	 ...
	 */
	public static function pdCategories($module = \app\modules\workflow\models\Workflow::MODULE_BLOG)
	{
		return ArrayHelper::map(self::find()->where(['cat_module'=>$module])->orderBy('name')->asArray()->all(), 'id', 'name');
	}
