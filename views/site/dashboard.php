...
//target urls
$target = Url::to(array('/purchase/purchase-order/update','id'=>''));
$targetWorkflow = Url::to(array('/purchase/purchase-order/workflow','id'=>''));
$targetEGP = Url::to(array('/purchase/purchase-order-group/purchase','id'=>''));
$targetPending = Url::to(array('/purchase/purchase-order-group/pending','id'=>''));

//grid urls
$gridURL = \Yii::$app->urlManager->createAbsoluteUrl('/purchase/purchase-order/dhtmlxgrid',['un'=> date('Ymd')]);
$gridWorkflowURL = \Yii::$app->urlManager->createAbsoluteUrl('/purchase/default/dhtmlxgrid',['un'=> date('Ymd')]);
$gridWorkflowURLApproved = \Yii::$app->urlManager->createAbsoluteUrl('/purchase/default/dhtmlxgridapproved',['un'=> date('Ymd'),'status'=>'approved']);
$gridWorkflowURLPending = \Yii::$app->urlManager->createAbsoluteUrl('/purchase/default/dhtmlxgridapproved',['un'=> date('Ymd'),'status'=>'pending']);
$gridWorkflowURLBooked = \Yii::$app->urlManager->createAbsoluteUrl('/purchase/default/dhtmlxgridapproved',['un'=> date('Ymd'),'status'=>'booked']);
...
function doOnRowPendingSelect(id,ind) {
  window.location = "$targetPending"+id; 
};
...
<div class="site-index">
  ...
  <div class="row">
    <div class="col-sm-8 col-md-4">
        <a href="<?= Url::to(['/purchase/purchase-order/create-request']); ?>" class="btn btn-success">
  ...
  echo Grid::widget(
    ...
    'clientOptions'=>[
        ...
        'columns' => [
          ...
          ['label'=>[Yii::t('app','Request Entity')],'type'=>'ro'],
...
<?php
  echo Grid::widget(
    ...
    'clientOptions'=>[
      ...
      'clientEvents'=>[
        'onRowDblClicked'=>'doOnRowPendingSelect',
        'onEnter' => 'doOnRowPendingSelect',
      ],
      'clientDataOptions'=>[
        'type'=>'json',
...
<?php
  $gridEGPURL = Url::to(['/purchase/default/dhtmlxgridegp','un'=> date('Ymd')]);  
?>
