...
<div class="workbench">
  ...
  <a href="<?= Url::to(['/dms/dmpaper/index','timefilter'=>'today']); ?>" class="btn btn-info btn-circle btn-xl tipster pull-right" id="back_review" title="<?= \Yii::t('app','todays inbox!'); ?>">
      <i class="fa fa-3x fa-chevron-down"></i><br>
      <b><?= Dmpaper::getStatisticForInboxByDays(1)->responsible()->one()->Inbox; ?> tdy</b>
  </a>

  <a href="<?= Url::to(['/dms/dmpaper/index','timefilter'=>'week']); ?>" class="btn btn-primary btn-circle btn-xl tipster pull-right" id="back_review" title="<?= \Yii::t('app','weeks inbox!'); ?>">
      <i class="fa fa-3x fa-chevron-down"></i><br>
      <b><?= Dmpaper::getStatisticForInboxByDays(7)->responsible()->one()->Inbox; ?> wk</b>
  </a>

  <a href="<?= Url::to(['/dms/dmpaper/index','timefilter'=>'month']); ?>" class="btn btn-success btn-circle btn-xl tipster pull-right" id="back_review" title="<?= \Yii::t('app','months inbox!'); ?>">
      <i class="fa fa-3x fa-chevron-down"></i><br>
