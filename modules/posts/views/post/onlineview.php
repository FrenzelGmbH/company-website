...
<div class="post-box">
  ...
  <div class="post-content">
    ...
    <?= app\modules\posts\widgets\WidgetBlogMapRender::widget(array(
      'module'=> app\modules\workflow\models\Workflow::MODULE_BLOG,
      'id'    => $model->id
    )); ?>
  </div>
...
<?php
  if(class_exists('\app\modules\posts\widgets\PortletPagination')){
    echo \app\modules\posts\widgets\PortletPagination::widget(array(
      'model'=>$model,
    )); 
  }
?>
